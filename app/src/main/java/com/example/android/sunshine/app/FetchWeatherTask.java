...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Uri locUri = WeatherContract.LocationEntry.CONTENT_URI;
        Cursor cursor = mContext.getContentResolver().query(
                locUri,
                new String[]{WeatherContract.LocationEntry._ID}, //return these columns
                WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?",  // "Where x = ?
                new String[]{locationSetting}, //this is "?"
                null); //sort parameter

        if(cursor.moveToFirst()) {
            int result = cursor.getColumnIndex(WeatherContract.LocationEntry._ID);
            locId = cursor.getLong(result);
        }else{

...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("The records do not match", queryData, testValues);
    ...
    public long testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long testRtnValue;
        testRtnValue = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,
                null,//all columns
                testValues);//
        assertTrue(testRtnValue != -1);
        // Query the database and receive a Cursor back
        Cursor queryData = db.query(
